...
import { FaCheckCircle, FaPlusCircle } from "react-icons/fa"; // Using FaPlusCircle for income theme
...
export default function IncomePage() {
  ...
  const handleSuccess = () => {
    ...
    // Clear the message after 4 seconds (4000ms) for better reading time
  ...
  return (
    ...
    <div className="relative flex items-center justify-center min-h-screen p-4 sm:p-8 overflow-hidden">
      {/* Background Gradients/Blobs - tailored for Income (Green/Cyan) */}
      <div className="absolute inset-0 z-0 opacity-70 dark:opacity-50">
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-green-400 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob dark:bg-green-700"></div>
        <div className="absolute top-1/2 right-1/4 w-72 h-72 bg-cyan-400 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000 dark:bg-cyan-700"></div>
        <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-teal-400 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-4000 dark:bg-teal-700"></div>
      </div>
      {/* Fallback background */}
      ...
      >
        ...
        <header className="mb-8 border-b border-gray-300 dark:border-gray-600 pb-4">
          <motion.div
            ...
            // Color theme set to green for Income
            className="flex items-center justify-center gap-4 text-green-500 dark:text-green-400"
          >
            <FaPlusCircle className="w-9 h-9 sm:w-12 sm:h-12 drop-shadow-md" />
          ...
          >
            Log your earnings to grow your net worth.
          </motion.p>
        </header>
      ...
      {/* Custom Tailwind CSS for animations and shadows (Same as ExpensePage) */}
      <style jsx global>{`
